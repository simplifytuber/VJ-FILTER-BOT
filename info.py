...
API_ID = int(environ.get('API_ID','24638450'))
API_HASH = environ.get('API_HASH', 'b720cf2f8cd64bc0ecee7ea3652a1cd1')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5965340120 6632019361 5497792868').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5965340120 6632019361 5497792868').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002425511186'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001820894005').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001817621287') # give your force subscribe channel id here else leave it blank
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '-1002425511186' LOG_CHANNEL))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001820894005')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://buddhu:buddhu@buddhu.xwhl5.mongodb.net/?")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "Buddhu")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'new_Lazy_files')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesimplyfytuber')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviesimplyfytuber')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/moviesimplyfytuber') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/moviesimplyfytuber')
